...
namespace Planning_platform.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Teacher_id,Student_id,Text,Date")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Teacher_id,Student_id,Text,Date")] Review review)
        {
            if (id != review.Id)
            {
                return NotFound();
